...
var aboutMore = document.querySelector('.about__info--more');
var aboutButton = document.querySelector('.about__button');
var aboutMobile = document.querySelector('.about__info--mobile');
function showMoreText() {
  aboutMore.style.display = 'none';
  aboutButton.style.display = 'flex';
  aboutButton.addEventListener('click', function () {
    aboutMore.style.display = 'none';
    var isOpened = aboutMore.classList.contains('is-open');
...
var buttonNav = document.querySelector('.footer__btn--nav');
var buttonContact = document.querySelector('.footer__btn--contact');
var blockNav = document.querySelector('.footer__nav-list');
var blockContact = document.querySelector('.footer__contact-list');
var footerTitleNav = document.querySelector('.footer__title--nav');
var footerTitleContact = document.querySelector('.footer__title--contact');
...
var inputName = document.querySelector('input[data-modal-name-input]');
...
function inputFormName() {
  ...
  inputName.forEach(function (item) {
    item.addEventListener('input', function () {
      var value = item.value.replace(/[^a-zA-ZА-Яа-яЁё'-]/gi, '');
      var nameLength = 20;
      var result = '';
